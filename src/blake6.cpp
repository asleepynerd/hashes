...
int main(int argc, char **argv)
{
    if (argc != 2)
    {
        cerr << "Usage: ./blake6 <message>" << endl;
        return 1;
    }
    ...
    {
        cout << "Usage: ./blake6 <message>" << endl;
        cout << "Options:" << endl;
...
void printHexString(unsigned long long *h)
{
    ...
    for (int i = 0; i < 8; i++)
    {
        printf("%016llx", h[i] >> 56);
        printf("%016llx", (h[i] >> 48) & 0xff);
        printf("%016llx", (h[i] >> 40) & 0xff);
        printf("%016llx", (h[i] >> 32) & 0xff);
        printf("%016llx", (h[i] >> 24) & 0xff);
        printf("%016llx", (h[i] >> 16) & 0xff);
        printf("%016llx", (h[i] >> 8) & 0xff);
        printf("%016llx", h[i] & 0xff);
    }
    printf("\n");
}